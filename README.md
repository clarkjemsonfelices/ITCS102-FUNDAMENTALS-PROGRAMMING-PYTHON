...
Selection Statement - if, elif, else (Student Discount)
...
[activity12.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity12.py)
For Loop - Printing 10 "Hello World"

[activity13.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity13.py)
For Loop - Adding All Numbers

[activity14.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity14.py)
For Loop - Printing Numbers in Descending Order

[activity15.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity15.py)
For Loop - Sum of all ODD Numbers

[activity16.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity16.py)
For Loop - Printing Horizontally (end="")

[activity17.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity17.py)
For Loop - For Loop inside For Loop (Printing 10 (1 - 10))

[activity18.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity18.py)
For Loop - Numbers in Triangle Shape

[activity19.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity19.py)
For Loop - Triangle

[activity20.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity20.py)
For Loop - Upside Down Triangle

[activity21.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity21.py)
While Loop - Washing Machine

[activity22.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity22.py)
Guessing Game - Importing Modules

[activity23.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity23.py)
List - Iteration, Slicing, reverse()

[activity24.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity24.py)
Functions - greet, factorial

[activity25.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity25.py)
Functions - Activities

[activity26.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity26.py)
Dictionary - programming languages

[activity27.py](https://github.com/clarkjemsonfelices/ITCS102-FUNDAMENTALS-PROGRAMMING-PYTHON/blob/main/activity27.py)
Dictionary - Adding Datas
